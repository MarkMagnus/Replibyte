---
title: Introduction
description: Replibyte is a tool to seed your development database with your production data while keeping sensitive data safe
hide_title: true
sidebar_position: 1
---
...
- [x] Support data backup and restore for PostgreSQL, MySQL
